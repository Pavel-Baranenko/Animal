...
<body class="contact-page">
	<div class="wrap-body">
		<div class="header">
			<div id='cssmenu' >
				<ul>
				   <li><a href='index.html'><span>Animal</span></a></li>
				   <li class=' has-sub'><a href='#'><span>Ктегория</span></a>
					  <ul>
				   ...
				   <li class='last active'><a href='contact.html'><span>Контакты</span></a></li>
				</ul>
			</div>
		</div>
		...
		<section id="container">
			<div class="wrap-container">
				...
				<div class="zerogrid">
					<div class="row">
						<h1 class="t-center" style="margin: 40px 0;color: #212121;letter-spacing: 2px;font-weight: 500;">Связаться с нами</h1>
						<div class="col-full">
						...
						<div class="col-2-3">
							<div class="wrap-col">
								<div class="contact">
									<h3 style="margin: 20px 0 20px 30px">контакт</h3>
									<!--Warning-->
				...
				<div class="row">
					...
					<div class="col-1-3 col-footer-2">
                     ...
                     <ul>
                        ...
                        <li><a href="#">5 МЕСТ, КОТОРЫЕ ОТЛИЧНО ПОДХОДЯТ ДЛЯ ОТДЫХА</a></li>
                        <li><a href="#">СОУЧРЕДИТЕЛЬ СТАРТАП-КОМПАНИИ РАССКАЗЫВАЕТ О СВОЕМ НОВОМ ПРОДУКТЕ</a></li>
                     </ul>
						</div>
					</div>
